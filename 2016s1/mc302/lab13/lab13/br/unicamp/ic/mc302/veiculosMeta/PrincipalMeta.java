...
//		pilha.adicionaVeiculo(new Caminhao(1007, 2));
		...
		pilha.adicionaVeiculo(FabricaVeiculos.novoCarro(1001, 5));
		pilha.adicionaVeiculo(FabricaVeiculos.novoCaminhao(1002, 2));
		pilha.adicionaVeiculo(FabricaVeiculos.novoCarro(1003, 2));
		pilha.adicionaVeiculo(FabricaVeiculos.novoCarro(1004, 5));
		pilha.adicionaVeiculo(FabricaVeiculos.novoCaminhao(1005, 1));
		pilha.adicionaVeiculo(FabricaVeiculos.novoCarro(1006, 6));
		pilha.adicionaVeiculo(FabricaVeiculos.novoCaminhao(1007, 2));
		
		pilha.mostrarPilhaDeVeiculos();

		// Mostrar total de instancia��es
		System.out.println("==============================");
		System.out.println("           TOTAIS");
		System.out.println("==============================");
		System.out.println("TOTAL DE VEICULOS:");
//		System.out.println("   " + Veiculo.getContadorVeiculos() + " unidades");
		System.out.println("   " + FabricaVeiculos.getContadorVeiculos() + " unidades");
		System.out.println("TOTAL DE CARROS:");
//		System.out.println("   " + Carro.getContadorCarros() + " unidades");
		System.out.println("   " + FabricaVeiculos.getContadorCarros() + " unidades");
		System.out.println("TOTAL DE CAMINHOES:");
//		System.out.println("   " + Caminhao.getContadorCaminhoes() + " unidades");
		System.out.println("   " + FabricaVeiculos.getContadorCaminhoes() + " unidades");
	}
}
